...
class PotentialAnswersControllerTest < ActionController::TestCase
  ...
  test "should create potential_answer" do
    ...
    assert_difference('PotentialAnswer.count') do
      post :create, potential_answer: { answer: @potential_answer.answer, answer_weight: @potential_answer.answer_weight, questions_id: @potential_answer.questions_id }
    end
  ...
  test "should update potential_answer" do
    sign_in users(:one)
    patch :update, id: @potential_answer, potential_answer: { answer: @potential_answer.answer, answer_weight: @potential_answer.answer_weight, questions_id: @potential_answer.questions_id }
    assert_redirected_to potential_answer_path(assigns(:potential_answer))
  end
